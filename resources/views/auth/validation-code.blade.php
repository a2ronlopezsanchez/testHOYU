      ...
      <div class="authentication-wrapper authentication-basic">
        <div class="authentication-inner py-4">
          ...
          <div class="card p-2">
            ...
            <!-- /Logo -->
            <div class="card-body">
              <h4 class="mb-2">Cambio de Contraseña 💬</h4>
              <p class="text-start mb-4">
                Hemos enviado un código de verificación a su número teléfoncio.                
                <span class="d-block mt-2">Ingresa los 6 dígitos del código de seguridad.</span>
              </p>
              @if ($errors->any())
              ...
              <form method="POST" action="{{ route('verifyToken') }}">
                ...
                <div class="mb-3">
                  <div
                    ...
                    <input
                      ...
                      id="digit1"
                      name="token[]"
                      class="form-control auth-input text-center numeral-mask h-px-50 mx-1 my-2"
                      maxlength="1"
                      required
                      autofocus />
                    <input
                ...
                <button class="btn btn-primary d-grid w-100 mb-3">VERIFICAR</button>
                <!--
                <div class="text-center">
                  ¿No has recibido el código? 
                  <a href="javascript:void(0);"> Vuelva a enviar </a>
                </div>
                -->
              </form>
            </div>
