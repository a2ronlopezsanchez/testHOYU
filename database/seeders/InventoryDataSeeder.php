...
class InventoryDataSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $data = [
            // Ejemplo con los datos que compartiste
            [
                // Datos del ItemParent (plantilla del producto)
                ...
                // Datos del InventoryItem (unidad individual)
                'sku' => 'BP#35617',
                'item_id' => 'AE001',
                'etiquetado' => 'SI',
                'comentarios' => 'BIEN',
            ...
            [
                'nombre_tecnico' => 'AMPLIFICADOR | ELECTROVOICE | P3000 | ID AE003',
                'categoria' => 'AUDIO',
                'marca' => 'ELECTROVOICE',
                'modelo' => 'P3000',
                'familia' => 'AMPLIFICADOR',
